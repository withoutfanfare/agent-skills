...
| A03 Software supply chain failures | Dependency audit clean or triaged (`dep-audit`, if installed); lock files committed; packages from trusted sources only; build and deploy pipeline secrets scoped and actions pinned. |
